...
public class UpdateLandmarksInformationBolt implements IRichBolt 
{
	...
	public UpdateLandmarksInformationBolt( boolean isReified, String storeConfigFile, String viewsConfigFile ) 
	{ 
